        ...
        <div className="justify-between px-4 mx-auto lg:max-w-7xl md:items-center md:flex md:px-8">
          <div>
            <div className="flex items-center justify-between py-3 md:py-5 md:block">
              <Link to="/">
                <h2 className="text-xl font-bold cursor-pointer md:text-2xl hover:text-red-500">
                  Pokemon
                </h2>
              </Link>
            ...
            >
              ...
              <div className="flex w-full mt-4 md:mt-0 md:w-auto">
                <input
                  type="text"
                  placeholder="Search..."
                  className="w-5/6 pl-1 border-2 border-black rounded-lg md:w-auto focus:border-red-500 focus:border-3 hover:border-red-500 focus:outline-none"
                  autoComplete="off"
                  value={dataInput}
